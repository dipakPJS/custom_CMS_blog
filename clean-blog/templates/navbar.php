...
<a class="navbar-brand" href="http://localhost/clean-blog/index.php"><img src="http://localhost/clean-blog/assets/img/logo.png" alt="logo-image" class="logo">_devine-Code</a>
...
<li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/clean-blog/posts/create.php">create</a></li>
 ...
 <?php echo $_SESSION['username']; ?>
    ...
    <li><a class="dropdown-item" href="http://localhost/clean-blog/users/profile.php?profile_id=<?php echo $_SESSION['user_id']; ?>">Profile</a></li>
...
<li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/clean-blog/terms.php">Terms and Conditions</a></li>
</ul>
</div>
</div>
</nav>